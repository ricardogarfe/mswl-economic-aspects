...
\subsection{True or False statements around  based on this 10 myths\ref(sec:flossmanuals)}
...
Mac has WebKit with Apache version2 to avoid poisoned contributions with GPL.

\begin{thebibliography}{9}

    \bibitem{flossmanuals}
        FLOSS Manuals,\\
        Generación de libros a partir de HTML,\\
        http://www.flossmanuals.net/

    \bibitem{flossmanuals}\label(sec:flossmanuals)
        Statements based on “Ten myths about FLOSS business models”,\\
        Carlo Daffara,\\
